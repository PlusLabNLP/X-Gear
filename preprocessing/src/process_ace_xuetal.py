...
from transformers import BertTokenizer, RobertaTokenizer, MT5Tokenizer, AutoTokenizer
...
def convert(input_file, output_file, tokenizer, window_size_=3, language='english'):
...
if __name__ == '__main__':
    ...
    if model_name.startswith('bert-'):
        ...
        bert_tokenizer = MT5Tokenizer.from_pretrained(model_name)    
    else:
        bert_tokenizer = AutoTokenizer.from_pretrained(args.bert, do_lower_case=False, use_fast=False)
    
    convert(args.input, args.output, bert_tokenizer, args.window, args.lang)
